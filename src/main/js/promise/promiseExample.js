...
function jury() {
    ...
    console.log('The jury is going to deliberate on ' + currentStdID);
    ...
    p1.then(sucessMsg => console.log(`${sucessMsg} graduated!`)).catch(failMsg => console.log(`Did not graduated :s: ${failMsg}`));
}
